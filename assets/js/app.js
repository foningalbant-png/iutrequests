        ...
        <div class="footer-grid">
          ...
          <div>
            ...
            <ul class="footer-links">
              ...
              <li><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="display:inline;vertical-align:middle;margin-right:6px"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72"/></svg><a href="https://wa.me/237600000000" target="_blank">WhatsApp</a></li>
            </ul>
          </div>
          <div>
            <h4>Liens</h4>
